...
- repoman. 
  ...
  This will checkout all of GlastRelease and its subpackages, using the L1 branch when appropriate.  It will also create a "bom" file which
  lists all the git commit tags associated with every package.
